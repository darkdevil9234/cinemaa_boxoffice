    ...
    if query.data.startswith("file"):
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="t.me/Cinemaa_boxoffice_support"),
                  InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="t.me/moviesworld738")
               ],[
                  InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Shazam_bot_support")
                 ]
                ]
            )
        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Shazam_bot_support")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
